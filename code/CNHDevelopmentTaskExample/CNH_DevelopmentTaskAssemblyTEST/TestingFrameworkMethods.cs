...
namespace CNH_DevelopmentTaskAssemblyTEST
{
    internal class TestingFrameworkMethods
    {
        ...
        /// <summary>
        /// This method takes an IDOExtensionClass definition and a context
        /// It provides a console interface for running static methods from the IDOExtensionClass
        /// </summary>
        /// <param name="extensionClassType">IDO Extension Class Type</param>
        /// <param name="context">IIDOCommands context</param>
